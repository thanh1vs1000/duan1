	...
	<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			...
			<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
				...
				<ul class="nav menu">
					<li class="active"><a href="quantri.php"><em class="fa fa-dashboard fa-lg">&nbsp;</em> Dashboard</a></li>
					...
					<li><a href="quantri.php?page=danh-sach-dang-ky"><em class="fa fa-users fa-lg">&nbsp;</em> Thành viên</a></li>
					<li><a href="quantri.php?page=thanh-vien"><em class="fa fa-youtube fa-lg">&nbsp;</em> Video giảng</a></li>
